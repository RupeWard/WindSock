// Same as Terrain Shader but with shadows & lightmap stuff stripped out (left as comments for reference)
Shader "Stick Sports/Terrain Shader No Shadows or Lightmap" {
	Properties
	{
...
//          		lightMapColor = ( ( lightMapColor - 0.5 ) * _LightMapIntensity + 0.5 ) * 2.0;
            	...
            	return _MainTint * texColor * secondTexColor * detailTexColor; // * atten
