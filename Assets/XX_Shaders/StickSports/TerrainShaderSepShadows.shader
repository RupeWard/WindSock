Shader "Stick Sports/Terrain Shader Sep Shadows" {
	Properties
	{
		...
		_BShadowTex ("Shadow Tex", 2D) = "white" {}
        	...
        	fixed4 frag(vertexOutput i) : COLOR 
         	{
         		//fixed atten = LIGHT_ATTENUATION(i); 	//This gets the shadow and attenuation values combined.
          		...
          		fixed4 b1ShadowColor = tex2D( _BShadowTex, i.b1ShadowTex_uv);
